...
const perguntas =[
    {
        enunciado: "1- Pessoas estão usando as redes sociais para competir por relevância dentro de uma plataforma, onde usam de sua influência para divulgar produtos ou marcas que incentivam o consumismo ou o gasto exagerado de dinheiro. Qual sua opinião sobre jogos de azar online? 1",
        alternativas:[
     ...
     {
        enunciado: "3- Sabemos que no mercado de jogos, existe um mercado interno criado para favorecerjogadores com itens pagos com dinheiro real, qual sua opinião sobre essa prática?",
        alternativas:[
                ...
                {texto:"b- Eu concordo, pois se a pessoa quer investir no jogo de forma consciente e dentro das regras do jogo ela pode, afinal essa opção existe para todos os jogadores e jogo precisa de lucro para continuar rodando como qualquer meio de lazer.",
